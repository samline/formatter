...
See [docs/options.md](options.md) for the full per-`formatType` field reference.
...
See [docs/api/regex.md](api/regex.md) for examples of every overload.
...
- [docs/options.md](options.md) — full `FormatOptions` reference, per-`formatType`.
- [docs/api/format.md](api/format.md) — `format()` signature, behaviour, edge cases.
- [docs/api/regex.md](api/regex.md) — `regex` dictionary and parametric helpers.
- [docs/recipes.md](recipes.md) — end-to-end React/Vue/Svelte examples that exercise these types.
